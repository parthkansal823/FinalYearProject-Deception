...
| 4     | Bait library — **invisibility gate first**                                    | ✅ gate built first; five deployed baits (a sixth withdrawn — see below), **calibrated** bite rates (per-category likelihood ratios)                                                                                                                                                                                                                                             |
