...
The report references each diagram as a PNG in `docs/img/diagrams/`, and those PNGs
...
3. Save into `docs/img/diagrams/` **keeping the same base name**.

| draw.io source | Export to | Figure |
|---|---|---|
| `drawio/fig01-graphical-abstract.drawio` | `docs/img/diagrams/fig01-graphical-abstract.png` | 1 |
| `drawio/fig10-decoy-consistency.drawio` | `docs/img/diagrams/fig10-decoy-consistency.png` | 10 |
| `drawio/fig11-layered-architecture.drawio` | `docs/img/diagrams/fig11-layered-architecture.png` | 11 |
| `drawio/fig12-overall-system-flow.drawio` | `docs/img/diagrams/fig12-overall-system-flow.png` | 12 |
| `drawio/fig13-sequence-diagram.drawio` | `docs/img/diagrams/fig13-sequence-diagram.png` | 13 |
| `drawio/fig14-dfd-level-0.drawio` | `docs/img/diagrams/fig14-dfd-level-0.png` | 14 |
| `drawio/fig15-dfd-level-1.drawio` | `docs/img/diagrams/fig15-dfd-level-1.png` | 15 |
| `drawio/fig16-use-case-diagram.drawio` | `docs/img/diagrams/fig16-use-case-diagram.png` | 16 |
| `drawio/fig17-class-diagram.drawio` | `docs/img/diagrams/fig17-class-diagram.png` | 17 |
| `drawio/fig18-session-state-machine.drawio` | `docs/img/diagrams/fig18-session-state-machine.png` | 18 |
| `drawio/fig20-evaluation-harness.drawio` | `docs/img/diagrams/fig20-evaluation-harness.png` | 20 |
...
python -m tools.make_docx       # writes docs/PROJECT_REPORT.docx
```
