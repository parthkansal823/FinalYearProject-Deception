...
| `tests/` | 365 automated tests across 26 files |
...
All 365 tests must pass before a model can be frozen.
...
3. **A test suite of 365 automated tests** across 26 files, which must pass
