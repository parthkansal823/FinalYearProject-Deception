...
\textbf{In scope.} The attacker sends ordinary-looking HTTP requests to a public
...
\code{/records/5} is syntactically indistinguishable from a request for \code{/records/6},
...
\textbf{Out of scope.} We do not defend against network- or transport-layer attacks,
...
measure a weaker version of it: an attacker who knows the \emph{defence} exists and
...
\textbf{Assumptions about the defender.} The defender runs a reverse proxy in front of
